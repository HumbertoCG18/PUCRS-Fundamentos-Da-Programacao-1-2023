...
public class AppAluno {
        public static void main(String[] args) {
                try (Scanner teclado = new Scanner(System.in)) {
                        ...
                        Aluno dois = new Aluno("Adao", 21, "Algebra", 7, 8, 10); // aqui estamos fazendo 2 em 1 criamos
                                                                                 // a variavel de objeto e ja
                                                                                 // imediatamente colocamos conteudo
                                                                                 // (endereço do objeto criado pelo NEW)
                        ...
                        Aluno tres = new Aluno(n, i, d, n1, n2, n3);// apos obter novos valores para os atrubutos eu
                                                                    // crio o objeto tres
                        ...
                        // calcular a media aritmetica de cada aluno ***acessar os dados de cada objeto
                        // --metodos ===mensagem objeto.metodo
                ...
                // como conteudo e um endere�o/referencia termos um determinado objeto cujo
                // endere�o esta em mais de um lugar
